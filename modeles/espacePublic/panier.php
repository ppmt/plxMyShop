   ...
   <form id="formcart" method="POST" action="#panier">
    ...
    <fieldset>
     ...
     <ol>
      ...
      <label for="nomCadeau" class="conteneurNomCadeau ninety fl pl" id="conteneurNomCadeau"<?php echo (!isset($_POST["choixCadeau"])) ? '' : ' style="display:block;"';?>> <?php $plxPlugin->lang('L_PUBLIC_GIFTNAME'); ?>&nbsp;:</label>
